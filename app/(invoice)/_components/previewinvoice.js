    ...
    <>
      ...
      className='sticky top-4 border border-slate-300 p-4 rounded-lg scale-75 bg-white'>
        ...
        <article className='my-8 flex flex-col items-end justify-end'>
          ...
          <p className='text-muted-foreground'>Due date: {values.dueDate && format(new Date(values.dueDate), "do MMMM yyyy")}</p>
        </article>
        ...
        <article className='border-t border-slate-300 py-8'>
          <ul className='flex flex-wrap items-center justify-center gap-4'>
            ...
            <li className='text-muted-foreground text-sm'>
              <span className='text-slate-800 font-bold'>Bank Account Holder: </span>
              {values.name}
            </li>
            <li className='text-muted-foreground text-sm'>
            ...
            <li className='text-muted-foreground text-sm'>
              <span className='text-slate-800 font-bold'>Bank Account Number: </span>
