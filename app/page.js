...
export default function Home() {
  ...
  return (
    ...
    <section className="relative py-32 space-y-8 max-w-4xl mx-auto text-center">
      ...
      <p className="text-muted-forground text-lg lg:text-xl">Easily create invoices for yourself, your clients all at the convenience of your mobile phone or PC. 
        This version offers improved performance, better responsiveness on mobile, 
        and better UI design by Alexandre Dincq.</p>
